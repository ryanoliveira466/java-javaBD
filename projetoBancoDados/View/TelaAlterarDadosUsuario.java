...
public class TelaAlterarDadosUsuario extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        pnlTituloLayout.setHorizontalGroup(
            ...
            .addGroup(pnlTituloLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(lblTitulo, javax.swing.GroupLayout.PREFERRED_SIZE, 603, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnAtualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAtualizarActionPerformed
        ...
        System.out.println("Email teste" + email.contains("@gmail"));
    ...
    private void btnResetActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnResetActionPerformed
        ...
        String mensagem = "Deseja realmente resetar a senha de ID: " + id + " ?";
        ...
        if (numeroRetorno.equals(0)) {
            UsuarioController op = new UsuarioController();
            op.resetarSenhaRegistroController(id);

            String mensagemExclusao = "Senha resetada com sucesso!";
            JOptionPane.showMessageDialog(null, mensagemExclusao);
        } else {
