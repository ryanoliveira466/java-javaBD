...
public class TelaOperCadastroUsuarios extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblImagem.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens/iconeFormulario.png"))); // NOI18N
        lblImagem.setText(" ");
        ...
        lblTitulo.setText("Formulário de Manutenção de Usuários - AppAsistência");
        ...
        pnlBotoes.setLayout(new java.awt.GridLayout(1, 7, 5, 5));
...
//        op.excluirRegistroController(idUser);
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        if (tbDadosUsuarios.getSelectedRow() == -1) {
            ...
            TelaAlterarDadosUsuario tela = new TelaAlterarDadosUsuario();
            tela.setVisible(true);
    ...
    private void btnIDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIDActionPerformed
         TelaBuscaPorID tela = new TelaBuscaPorID();
         tela.setVisible(true);
         this.dispose();
