 ...
 * @author Aluno
 */
public class TelaBuscaPorID extends javax.swing.JFrame {

    /**
     * Creates new form TelaNovoUsuario
     */
    public TelaBuscaPorID() {
        initComponents();
    ...
    private void initComponents() {
        ...
        pnlDados.add(lblPassword);
        pnlDados.add(txtPassword);
...
//        }
        ...
        //        }
            ...
            UsuarioModel usuario = op.buscarPorIdRegistroController(id);

            if (usuario.getUsername() == null || usuario.getEmail() == null
                    || usuario.getLogin() == null || usuario.getPassword() == null) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaBuscaPorID.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaBuscaPorID().setVisible(true);
            }
        });
    }
